...
- [x] [F02.5.3 — Record unmodified full conformance-suite roots](03-full-suite-record/README.md)
- [x] [F02.5.4 — Cut over inventory and source consumers atomically](04-inventory-and-consumer-cutover/README.md)
