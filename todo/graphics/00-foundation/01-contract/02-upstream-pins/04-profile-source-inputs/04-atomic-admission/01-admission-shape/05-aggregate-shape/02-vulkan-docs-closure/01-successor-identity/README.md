...
An isolated, opt-in successor fixture contract defines truthful raw members, generated members, and logical
closures without changing the active F02.1/F02.2 manifest, inventory layout, candidate audit JSON, cache,
F03 gate, or V1 transition grammar.
...
- [ ] Model a tagged raw-versus-generated member union and one ordered logical closure identity.
- [ ] Keep F02.2's per-member 8 MiB rule and reject root-only, duplicate, unordered, and oversize members.
- [ ] Require generated producer members, recipe, configuration, toolchain, output, and determinism identities.
- [ ] Preserve V1/audit data only as immutable predecessor evidence through a successor adapter boundary.
- [ ] Add hermetic hostile tests and a focused PASS receipt without changing active consumers.
