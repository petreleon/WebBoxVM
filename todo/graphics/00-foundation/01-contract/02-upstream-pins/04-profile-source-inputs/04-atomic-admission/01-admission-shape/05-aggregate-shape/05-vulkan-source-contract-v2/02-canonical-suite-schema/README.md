...
- [x] Pin tag object, peeled commit, root URL, root SHA-256, and root byte count.
- [x] Specify an ordered recursive ledger of safe POSIX paths, blob identities, byte counts, and hashes.
- [x] Keep source input and suite closure types separate; V1 loaders and receipts stay unchanged.
- [x] Define explicit member, per-member, and aggregate limits from the audited suite boundary.
- [x] Add positive and hostile schema tests for substituted roots, paths, duplicates, cycles, and hashes.
