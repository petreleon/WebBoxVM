...
Revision: 62634ca6486e4ed7153434d4f2bf80dbf01bc806
Validation: focused 3/3, predecessor checks, source limits, roadmap checker, diff, and make test
Result: PASS
Artifacts: contract self-hash 63e41c35e1f78f7eecee9241153f3cf2135cda48ca674d399a28b4310d501899
...
Tested commit and documentation diff: 62634ca6486e4ed7153434d4f2bf80dbf01bc806 is the exact
tested feature revision. It corrects the earlier ambiguous producer flag while retaining d6d96db4's
F02 cache-grammar correction; this receipt and checklist update are documentation-only afterward.
...
expressly records `producer_execution_required_for_this_capture: false`,
`producer_execution_proved: false`, and no output attestation. The next raw-source capture does not
execute those producer entrypoints.
...
(15/0/0). Cargo 1.93.0 ran the source-limit test (6/0/0). make test reported 1,130 Rust passed /
...
non-F02 cache grammar, missing cache identity, a producer-execution or output-attestation claim,
fresh-cache claim, active-v2 mutation, admission promotion, stale self-hash, duplicate keys,
oversized input, FIFO, and symlink.

Reproduction artifacts: gles_successor_contract.py SHA-256
b65676c10b88da4d846bb9ca414365c8faa6e56f52d1e2ba665db7b02363144c; record SHA-256
d9cf52837ae057db898d783d0df1a70ee7c619fa17acc63012742691e5fe0ce1; test SHA-256
d4fbb0a66245f6fab8106f92d13c8b050088328511c7276f0a16161b0a93d827. No payload, capture, or
...
Commit/push verification: d6d96db4, 134e03ed, and corrective commit 62634ca are local on
codex/graphics-f01-baseline.
