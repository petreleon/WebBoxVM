...
Evidence: [receipt](evidence.md); child evidence: [sealed capture binding](01-bind-sealed-capture/evidence.md) · [consumer revalidation](02-revalidate-consumers/evidence.md) · [atomic reconciliation](03-reconcile-atomic-result/evidence.md)
...
- [x] [Revalidate the F02 and F03 consumers](02-revalidate-consumers/README.md)
- [x] [Reconcile the atomic blocked result](03-reconcile-atomic-result/README.md)
