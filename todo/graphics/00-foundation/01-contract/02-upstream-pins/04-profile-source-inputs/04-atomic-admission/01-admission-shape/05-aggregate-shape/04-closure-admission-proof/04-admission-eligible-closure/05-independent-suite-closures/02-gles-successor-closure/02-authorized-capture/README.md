...
Evidence: [receipt](evidence.md); child evidence: [closure contract](01-closure-contract/evidence.md), [capture and replay](02-capture-and-replay/evidence.md), [atomic consumers](03-atomic-consumers/evidence.md)
...
- [x] [Capture and replay the complete GLES closure](02-capture-and-replay/README.md)
- [x] [Atomically revalidate successor consumers](03-atomic-consumers/README.md)
