...
- [ ] Bind the reviewed image, platform, argv, environment, mounts, recipe/toolchain, source identities, and both clean-run identities.
- [ ] Enforce per-tree bounds of 4,096 regular files and 32 MiB while rehashing exactly 2,530 files and 17,019,466 bytes per selected tree.
- [ ] Require tree SHA-256 `26e8e484d34222d9ba8a72c883ff8bb65a4e5194f399c24aa9bd5d7e47c49f32` and primary `out/html/vkspec.html` at 10,377,052 bytes with SHA-256 `896452d3a3e4887ba1bad81a6b9b91e9b3b324e1fffbb9e1dec889d0b06ac041`.
- [ ] Reject unsafe paths, symlinks/non-regular files, missing/extra/duplicate members, partial trees, altered primary HTML, aliasing, output/source substitution, or witness mutations.
- [ ] Add positive and hostile output-tree, build-identity, bounds, and descriptor-filesystem regressions with a compact receipt.
