...
pub(super) fn add_virtio_devices(builder: &mut DtbBuilder) {
    add_virtio_blk(builder, "virtio_blk@a000000", VIRTIO_BLK_BASE, 16);
    add_virtio_blk(builder, "virtio_blk@a001000", VIRTIO_DISK_BASE, 17);
}
...
fn add_virtio_blk(builder: &mut DtbBuilder, name: &str, base: u64, spi: u32) {
