...
pub(crate) fn trace_statx(cpu: &mut Armv8Cpu, bus: &SystemBus, sx: u64) {
...
pub(crate) fn trace_read_c_string(
    cpu: &mut Armv8Cpu,
    bus: &SystemBus,
    va: u64,
    max_len: u64,
...
pub(crate) fn format_trace_string(value: Option<&str>) -> String {
    match value {
...
pub(crate) fn trace_read_u8(cpu: &mut Armv8Cpu, bus: &SystemBus, va: u64) -> Option<u64> {
