...
pub(super) const GPU_VIRTIO_MMIO_ARG: &str = "virtio_mmio.device=4K@0x0a003000:51";
pub(super) const DEFAULT_ISO_BOOTARGS: &str = "earlycon=pl011,0x09000000 console=ttyAMA0,115200n8 loglevel=7 kvm-arm.mode=none kvm.enable_virt_at_load=0 initcall_blacklist=finalize_pkvm,bpf_tcp_ca_kfunc_init cryptomgr.notests=1 virtio_mmio.device=4K@0x0a000000:48 virtio_mmio.device=4K@0x0a001000:49 virtio_mmio.device=4K@0x0a002000:50 virtio_mmio.device=4K@0x0a003000:51 clocksource.arm_arch_timer.evtstrm=false auto=false";
...
pub(super) fn ensure_serial_bootargs(args: &str) -> String {
    ...
    ensure_kernel_token(&mut tokens, GPU_VIRTIO_MMIO_ARG);
    ensure_kernel_arg(
        &mut tokens,
