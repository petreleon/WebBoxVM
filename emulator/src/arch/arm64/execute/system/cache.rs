...
use crate::arch::arm64::mmu::translate_write;
use crate::arch::arm64::{Armv8Cpu, Instr};
use crate::constants::DCZID_EL0_VAL;
use crate::platform::virt::SystemBus;

pub(in crate::arch::arm64::execute) fn exec_dc_zva(
    cpu: &mut Armv8Cpu,
    bus: &mut SystemBus,
    instr: Instr,
) -> Result<(), &'static str> {
...
pub(in crate::arch::arm64::execute) fn exec_dc_gva(
    cpu: &mut Armv8Cpu,
    bus: &mut SystemBus,
    instr: Instr,
) -> Result<(), &'static str> {
