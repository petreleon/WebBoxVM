pub(in crate::arch::arm64::execute) fn simd_replicate_byte(byte: u8) -> u128 {
    let mut value = 0u128;
    for lane in 0..16 {
...
pub(in crate::arch::arm64::execute) fn simd_vector_mask(vector_size: usize) -> u128 {
    match vector_size {
        0 => 0,
        16.. => u128::MAX,
...
pub(in crate::arch::arm64::execute) fn simd_element_mask(element_size: usize) -> u128 {
...
pub(in crate::arch::arm64::execute) fn simd_byte(value: u128, lane: usize) -> u8 {
    ((value >> (lane * 8)) & 0xff) as u8
}

pub(in crate::arch::arm64::execute) fn simd_element(
    value: u128,
    lane: usize,
    element_size: usize,
) -> u128 {
...
pub(in crate::arch::arm64::execute) fn simd_reverse_elements_in_groups(
    value: u128,
    element_size: usize,
    vector_size: usize,
    group_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_signed_element(
    value: u128,
    lane: usize,
    element_size: usize,
) -> i64 {
...
pub(in crate::arch::arm64::execute) fn simd_signed_element_value(
    raw: u128,
    element_size: usize,
) -> i64 {
    let bits = element_size * 8;
...
pub(in crate::arch::arm64::execute) fn simd_replicate_element(
    element: u128,
    element_size: usize,
    vector_size: usize,
) -> u128 {
