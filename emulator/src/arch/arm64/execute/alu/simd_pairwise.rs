...
pub(in crate::arch::arm64::execute) fn simd_pairwise_binary<F>(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_zip(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_trn(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_uzp(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
