...
pub(in crate::arch::arm64::execute) fn exec_simd_data(cpu: &mut Armv8Cpu, instr: Instr) {
    match instr.op {
        ...
        | Opcode::SimdFcvtl2
        | Opcode::SimdFcvtn
        | Opcode::SimdFcvtn2 => exec_simd_fp_convert(cpu, instr),
        Opcode::SimdFpAbsVec
        ...
        Opcode::SimdMulVec | Opcode::SimdMlaVec | Opcode::SimdMlsVec => exec_simd_mul(cpu, instr),
        Opcode::SimdAddp
        | Opcode::SimdAddv
        | Opcode::SimdSmaxv
        | Opcode::SimdSminv
        ...
        | Opcode::SimdZip2
        | Opcode::SimdTbl
        | Opcode::SimdTbx => exec_simd_permute(cpu, instr),
        Opcode::SimdNot
        | Opcode::SimdRbit
        | Opcode::SimdBsl
        | Opcode::SimdBit
