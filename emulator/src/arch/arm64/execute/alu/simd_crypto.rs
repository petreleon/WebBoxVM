...
pub(in crate::arch::arm64::execute) fn is_simd_crypto_opcode(op: Opcode) -> bool {
...
pub(in crate::arch::arm64::execute) fn exec_simd_crypto(cpu: &mut Armv8Cpu, instr: Instr) {
