...
pub(in crate::arch::arm64::execute) fn simd_elementwise_binary<F>(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_elementwise_ternary<F>(
    dst: u128,
    lhs: u128,
    rhs: u128,
    element_size: usize,
...
pub(in crate::arch::arm64::execute) fn simd_fp_elementwise_binary<F32, F64>(
    lhs: u128,
    rhs: u128,
    element_size: usize,
    vector_size: usize,
