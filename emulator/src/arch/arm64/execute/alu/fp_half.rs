pub(in crate::arch::arm64::execute) fn f16_to_f32(bits: u16) -> f32 {
...
pub(in crate::arch::arm64::execute) fn f32_to_f16_bits(value: f32) -> u16 {
...
pub(in crate::arch::arm64::execute) fn f64_to_f16_bits(value: f64) -> u16 {
    let bits = value.to_bits();
