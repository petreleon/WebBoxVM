...
pub(in crate::arch::arm64::execute) fn signed_max(a: u128, b: u128, element_size: usize) -> u128 {
...
pub(in crate::arch::arm64::execute) fn signed_min(a: u128, b: u128, element_size: usize) -> u128 {
    if simd_signed_element_value(a, element_size) <= simd_signed_element_value(b, element_size) {
        a
    } else {
        b
...
pub(in crate::arch::arm64::execute) fn unsigned_reduce(
    value: u128,
    element_size: usize,
    vector_size: usize,
    max: bool,
...
pub(in crate::arch::arm64::execute) fn signed_reduce(
    value: u128,
    element_size: usize,
    vector_size: usize,
    max: bool,
