...
pub(in crate::arch::arm64::execute) fn exec_simd_fp_mulx(cpu: &mut Armv8Cpu, instr: Instr) {
...
pub(in crate::arch::arm64::execute) fn exec_simd_fp_mulx_elem(cpu: &mut Armv8Cpu, instr: Instr) {
