...
pub(in crate::arch::arm64::execute) fn read_fp_bits(cpu: &Armv8Cpu, reg: u8, size: u8) -> u64 {
    match size {
...
pub(in crate::arch::arm64::execute) fn write_fp_bits(
    cpu: &mut Armv8Cpu,
    reg: u8,
    bits: u64,
    size: u8,
...
pub(in crate::arch::arm64::execute) fn read_fp_as_f64(cpu: &Armv8Cpu, reg: u8, size: u8) -> f64 {
    match size {
