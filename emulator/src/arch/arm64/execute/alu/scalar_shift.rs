...
pub(in crate::arch::arm64::execute) enum ShiftDir {
    Left,
    Right,
    ArithRight,
    RotateRight,
...
pub(in crate::arch::arm64::execute) fn exec_variable_shift(
    cpu: &mut Armv8Cpu,
    instr: Instr,
    dir: ShiftDir,
) {
...
pub(in crate::arch::arm64::execute) fn exec_extract(cpu: &mut Armv8Cpu, instr: Instr) {
