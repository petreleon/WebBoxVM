...
pub(super) fn simd_half_offset(reg: u8, high: bool) -> u64 {
    JIT_STATE_SIMD_OFFSET + reg as u64 * 16 + u64::from(high) * 8
}
...
pub(super) fn can_emit_bitfield(instr: crate::arch::arm64::Instr) -> bool {
