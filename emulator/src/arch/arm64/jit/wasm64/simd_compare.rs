...
impl WasmExpr {
    pub(super) fn emit_simd_cmeq_zero(&mut self, instr: crate::arch::arm64::Instr) -> bool {
    ...
    pub(super) fn emit_simd_cmeq_reg(&mut self, instr: crate::arch::arm64::Instr) -> bool {
    ...
    pub(super) fn emit_simd_unsigned_cmp_reg(&mut self, instr: crate::arch::arm64::Instr) -> bool {
        if instr.imm != 1 || !matches!(instr.size, 8 | 16) || instr.rm == 0xff {
            return false;
        }
