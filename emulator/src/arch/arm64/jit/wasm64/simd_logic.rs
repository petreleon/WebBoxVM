...
impl WasmExpr {
    ...
    fn emit_logic_half_value(&mut self, instr: Instr, high: bool) {
        match instr.op {
            Opcode::SimdAnd => self.emit_binary_logic(instr.rn, instr.rm, high, OP_I64_AND, false),
            Opcode::SimdBic => self.emit_binary_logic(instr.rn, instr.rm, high, OP_I64_AND, true),
            ...
            Opcode::SimdEor => self.emit_binary_logic(instr.rn, instr.rm, high, OP_I64_XOR, false),
