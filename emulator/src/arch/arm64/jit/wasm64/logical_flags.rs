use super::opcodes::*;
use super::*;
use crate::constants::{PSTATE_N_BIT, PSTATE_NZCV_MASK, PSTATE_Z_BIT};

const LOCAL_RESULT: u32 = 1;

impl WasmExpr {
    pub(super) fn emit_ands_imm(&mut self, instr: crate::arch::arm64::Instr) {
    ...
    pub(super) fn emit_ands_reg(&mut self, instr: crate::arch::arm64::Instr) -> bool {
