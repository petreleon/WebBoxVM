...
pub(super) fn map(raw: u32, m: disarm64::decoder::Mnemonic) -> Option<Opcode> {
    ...
    Some(match m {
        ...
        M::r#frintn if (raw & 0xBFBF_FC00) == 0x0E39_8800 || (raw & 0xBFBF_FC00) == 0x0E21_8800 => {
        ...
        M::r#fnmla if (raw & 0xFF20_E000) == 0x6520_4000 => Opcode::SveFpFnmla,
