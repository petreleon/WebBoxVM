...
fn decode_scalar_byte_halfword_load_store_cross_checked_with_disarm64() {
    let cases = [
        ...
        (0x3980_1CC5, Opcode::LdrSign, "ldrsb", 1, true),
        (0x79C0_1107, Opcode::LdrSign, "ldrsh", 2, false),
        (0x38DF_F149, Opcode::LdrSign, "ldursb", 1, false),
        (0x789F_A041, Opcode::LdrSign, "ldursh", 2, true),
        (0xB89F_8083, Opcode::LdrSign, "ldursw", 4, true),
        (0x38A7_6863, Opcode::LdrSign, "ldrsb", 1, true),
