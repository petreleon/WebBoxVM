...
pub(super) const UARTPERIPHID0_OFFSET: u64 = 0xFE0;
pub(super) const UARTPERIPHID1_OFFSET: u64 = 0xFE4;
pub(super) const UARTPERIPHID2_OFFSET: u64 = 0xFE8;
pub(super) const UARTPERIPHID3_OFFSET: u64 = 0xFEC;
/// PrimeCell component identification registers.
pub(super) const UARTPCELLID0_OFFSET: u64 = 0xFF0;
pub(super) const UARTPCELLID1_OFFSET: u64 = 0xFF4;
pub(super) const UARTPCELLID2_OFFSET: u64 = 0xFF8;
pub(super) const UARTPCELLID3_OFFSET: u64 = 0xFFC;
