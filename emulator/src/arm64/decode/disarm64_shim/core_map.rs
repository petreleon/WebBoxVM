...
pub(super) fn map(raw: u32, m: disarm64::decoder::Mnemonic) -> Option<Opcode> {
    ...
    Some(match m {
        ...
        M::r#bl => Opcode::Bl,
        M::r#braa | M::r#braaz | M::r#brab | M::r#brabz => Opcode::Br,
        M::r#blraa | M::r#blraaz | M::r#blrab | M::r#blrabz => Opcode::Blr,
        M::r#br => Opcode::Br,
        M::r#blr => Opcode::Blr,
        M::r#eretaa | M::r#eretab => Opcode::Eret,
        M::r#retaa | M::r#retab => Opcode::Ret,
        M::r#ret => Opcode::Ret,
        M::r#cbz => Opcode::Cbz,
        ...
        M::r#addspl => Opcode::SveAddspl,
        M::r#rdvl => Opcode::SveRdvl,
        M::r#rdsvl => Opcode::SveRdsvl,
