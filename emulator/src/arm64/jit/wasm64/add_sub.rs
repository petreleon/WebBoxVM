...
impl WasmExpr {
    pub(super) fn emit_add_sub_imm(&mut self, instr: crate::arm64::Instr) {
    ...
    pub(super) fn emit_add_sub_reg(&mut self, instr: crate::arm64::Instr) -> bool {
    ...
    pub(super) fn emit_add_sub_ext(&mut self, instr: crate::arm64::Instr) -> bool {
