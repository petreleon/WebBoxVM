...
pub(in crate::arm64::execute) fn simd_lane_mask(element_size: usize, shift: usize) -> u128 {
...
pub(in crate::arm64::execute) fn exec_ld1_multi(
    cpu: &mut Armv8Cpu,
    bus: &mut SystemBus,
    va: u64,
    instr: Instr,
...
pub(in crate::arm64::execute) fn exec_st1_multi(
    cpu: &mut Armv8Cpu,
    bus: &mut SystemBus,
    va: u64,
    instr: Instr,
...
pub(in crate::arm64::execute) fn exec_ld_structure(
    cpu: &mut Armv8Cpu,
    bus: &mut SystemBus,
    va: u64,
    instr: Instr,
...
pub(in crate::arm64::execute) fn simd_structure_lanes(instr: Instr) -> Result<usize, &'static str> {
    let element_size = 1usize << instr.cond;
