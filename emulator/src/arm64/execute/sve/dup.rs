...
pub(in crate::arm64::execute) fn exec_sve_cpy_imm(cpu: &mut Armv8Cpu, instr: Instr) {
    exec_sve_cpy_value(cpu, instr, instr.imm);
}

pub(in crate::arm64::execute) fn exec_sve_cpy_gpr(cpu: &mut Armv8Cpu, instr: Instr) {
