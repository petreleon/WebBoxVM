...
pub(in crate::arm64::execute) fn set_nz_flags(cpu: &mut Armv8Cpu, val: u64, sf: bool) {
    let sb = sign_bit(sf);
...
pub(in crate::arm64::execute) fn add_flags(
    cpu: &mut Armv8Cpu,
    lhs: u64,
    rhs: u64,
    sf: bool,
...
pub(in crate::arm64::execute) fn sub_flags(
    cpu: &mut Armv8Cpu,
    lhs: u64,
    rhs: u64,
    sf: bool,
...
pub(in crate::arm64::execute) fn exec_addsub_carry(cpu: &mut Armv8Cpu, instr: Instr) {
