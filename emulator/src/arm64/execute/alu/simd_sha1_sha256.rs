...
pub(in crate::arm64::execute) fn is_simd_sha1_sha256_opcode(op: Opcode) -> bool {
    matches!(
        op,
        Opcode::SimdSha1h
...
pub(in crate::arm64::execute) fn exec_simd_sha1_sha256(cpu: &mut Armv8Cpu, instr: Instr) {
