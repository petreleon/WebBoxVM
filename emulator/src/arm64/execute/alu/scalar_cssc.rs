...
pub(in crate::arm64::execute) fn exec_smax(cpu: &mut Armv8Cpu, instr: Instr) {
    exec_signed_minmax(cpu, instr, true);
}

pub(in crate::arm64::execute) fn exec_smin(cpu: &mut Armv8Cpu, instr: Instr) {
    exec_signed_minmax(cpu, instr, false);
}

pub(in crate::arm64::execute) fn exec_umax(cpu: &mut Armv8Cpu, instr: Instr) {
    exec_unsigned_minmax(cpu, instr, true);
}

pub(in crate::arm64::execute) fn exec_umin(cpu: &mut Armv8Cpu, instr: Instr) {
