...
impl super::Opcode {
    ...
    pub const SveIncpVector: Self = Self(523);
    ...
    pub const SveFpFnmla: Self = Self(490);
    ...
    pub const SveCpyImm: Self = Self(484);
    pub const SveCpyGpr: Self = Self(485);
    ...
    pub const SveUzp1: Self = Self(481);
    pub const SveUzp2: Self = Self(482);
    pub const SveUqadd: Self = Self(483);
    pub const SveXar: Self = Self(428);
    pub const SveTbl: Self = Self(453);
    pub const SveRevh: Self = Self(456);
    pub const SveIndex: Self = Self(460);
}
