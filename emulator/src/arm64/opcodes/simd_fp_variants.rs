...
impl super::Opcode {
    ...
    pub const SimdFcvtl: Self = Self(471);
    pub const SimdFcvtl2: Self = Self(472);
    pub const SimdFcvtn: Self = Self(473);
    pub const SimdFcvtn2: Self = Self(474);
    ...
    pub const SimdFpFcmeqVec: Self = Self(392);
