...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let (mut repeat_completed, mut linear_completed, mut texture_pair_completed, mut vertex_color_completed, mut texture_color_completed, mut uniform_completed, mut depth_vertex_color_completed, mut depth_texture_completed) = (false, false, false, false, false, false, false, false);
