...
import { drainNetworkTx, startNetworkProxy, stopNetworkProxy } from "./network.js?v=20260718-staged-fast-boot";
import { NETWORK_TX_POLL_INTERVAL_MS, state } from "./state.js?v=20260718-staged-fast-boot";
