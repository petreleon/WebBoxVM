...
import { tryRunOrCompileJitBlock } from "./jit-hot.js?v=20260904-virgl-depth-batch-compare-r1";
import { DEFAULT_JIT_ENABLED, JIT_MAX_HIT_SITES, resetJitState, state } from "./state.js?v=20260904-virgl-depth-batch-compare-r1";
