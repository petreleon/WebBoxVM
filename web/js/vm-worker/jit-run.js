import { compileJitBlock, jitBlockKey } from "./jit-compile.js?v=20260903-virgl-capset1-r2";
import { pcForCore } from "./jit-core.js?v=20260903-virgl-capset1-r2";
import { postMetrics } from "./metrics-events.js?v=20260903-virgl-capset1-r2";
import { state } from "./state.js?v=20260903-virgl-capset1-r2";
import { requireEmulator } from "./lifecycle.js?v=20260903-virgl-capset1-r2";
