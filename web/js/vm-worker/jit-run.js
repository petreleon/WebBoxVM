import { compileJitBlock, jitBlockKey } from "./jit-compile.js?v=20260903-virgl-viewport-r1";
import { pcForCore } from "./jit-core.js?v=20260903-virgl-viewport-r1";
import { postMetrics } from "./metrics-events.js?v=20260903-virgl-viewport-r1";
