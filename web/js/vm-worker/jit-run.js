import { compileJitBlock, jitBlockKey } from "./jit-compile.js?v=20260904-virgl-depth-compare-r1";
import { pcForCore } from "./jit-core.js?v=20260904-virgl-depth-compare-r1";
import { postMetrics } from "./metrics-events.js?v=20260904-virgl-depth-compare-r1";
import { state } from "./state.js?v=20260904-virgl-depth-compare-r1";
import { requireEmulator } from "./lifecycle.js?v=20260904-virgl-depth-compare-r1";
