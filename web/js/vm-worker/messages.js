...
} from "./lifecycle.js?v=20260903-virgl-capset1-r1";
import { withEmulatorAccess } from "./access.js?v=20260903-virgl-capset1-r1";
import { compileJitBlock } from "./jit-compile.js?v=20260903-virgl-capset1-r1";
import { errorMessage } from "./errors.js?v=20260903-virgl-capset1-r1";
import { runJitBlock } from "./jit-run.js?v=20260903-virgl-capset1-r1";
import { schedulePump } from "./pump.js?v=20260903-virgl-capset1-r1";
