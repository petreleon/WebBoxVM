...
} from "./lifecycle.js?v=20260904-virgl-mixed-depth-batch-r1";
import { withEmulatorAccess } from "./access.js?v=20260904-virgl-mixed-depth-batch-r1";
import { compileJitBlock } from "./jit-compile.js?v=20260904-virgl-mixed-depth-batch-r1";
import { errorMessage } from "./errors.js?v=20260904-virgl-mixed-depth-batch-r1";
import { runJitBlock } from "./jit-run.js?v=20260904-virgl-mixed-depth-batch-r1";
