...
import { parseGpu3dPacket } from "./gpu-3d-packet.js?v=20260904-virgl-depth-texture-color-r1";
import { virglDrawPacket } from "./gpu-test-packets.mjs?v=20260904-virgl-depth-texture-color-r1";
