...
import { parseGpu3dPacket } from "./gpu-3d-packet.js?v=20260904-virgl-depth-compare-r1";
import { virglDrawPacket } from "./gpu-test-packets.mjs?v=20260904-virgl-depth-compare-r1";
import { virglVertexColorPacket } from "./gpu-test-virgl-vertex-color.mjs?v=20260904-virgl-depth-compare-r1";
import { virglTextureColorPacket } from "./gpu-test-virgl-texture-color.mjs?v=20260904-virgl-depth-compare-r1";
