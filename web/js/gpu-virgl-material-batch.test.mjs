...
import { GuestDisplay, parseGpu3dPacket } from "./gpu-display.js?v=20260904-virgl-material-batch-r1";
import { fakeAdapter, fakeCanvas, fakeDevice, fakeGpu, fakeStatus } from "./gpu-test-fakes.mjs?v=20260904-virgl-material-batch-r1";
import { virglMaterialBatchPacket } from "./gpu-test-virgl-material-batch.mjs?v=20260904-virgl-material-batch-r1";
...
test("VirGL material-batch renderer submits one depth pass for mixed materials", async () => {
  ...
  assert.deepEqual(await display.present3d(virglMaterialBatchPacket({ sequence: 93 })), { sequence: 93, success: true });
