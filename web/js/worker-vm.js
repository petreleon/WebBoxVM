import { transferableBytes } from "./worker-vm/bytes.js?v=20260903-virgl-viewport-r1";
import { versionedUrl } from "./asset-version.js?v=20260903-virgl-viewport-r1";
import { WorkerChannel } from "./worker-vm/channel.js?v=20260903-virgl-viewport-r1";
