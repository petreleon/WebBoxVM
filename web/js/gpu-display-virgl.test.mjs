...
import { GuestDisplay } from "./gpu-display.js?v=20260904-virgl-depth-compare-r1";
import { fakeAdapter, fakeCanvas, fakeDevice, fakeGpu, fakeStatus }
  from "./gpu-test-fakes.mjs?v=20260904-virgl-depth-compare-r1";
import {
  virglClearPacket, virglDrawPacket, virglTexturedMultiplyPacket, virglTexturedPacket,
} from "./gpu-test-packets.mjs?v=20260904-virgl-depth-compare-r1";
