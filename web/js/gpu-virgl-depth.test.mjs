...
import { fakeAdapter, fakeCanvas, fakeDevice, fakeGpu, fakeStatus }
  from "./gpu-test-fakes.mjs?v=20260904-virgl-material-batch-r1";
import { virglDepthPacket, virglDepthTexturePacket } from "./gpu-test-virgl-depth.mjs?v=20260904-virgl-material-batch-r1";
