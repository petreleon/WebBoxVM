...
export class VirglDepthBatchRenderer {
  #bufferUsage; #depthCompare; #depthTexture; #generation = 0; #height = 0; #pipeline; #revision = 0;
  ...
  invalidate() {
    ...
    this.#vertexBuffer = undefined; this.#depthCompare = undefined; this.#depthTexture = undefined; this.#pipeline = undefined;
