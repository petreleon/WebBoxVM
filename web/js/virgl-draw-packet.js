import { parseVirglVertexColorPacket } from "./virgl-vertex-color-packet.js?v=20260904-virgl-depth-compare-r1";
import { parseVirglTextureColorPacket } from "./virgl-texture-color-packet.js?v=20260904-virgl-depth-compare-r1";
import { parseVirglDepthPacket } from "./virgl-depth-packet.js?v=20260904-virgl-depth-compare-r1";
...
export function parseVirglDrawPacket(packet) {
  ...
  if (version === 9 || version === 10) return parseVirglDepthPacket(packet);
