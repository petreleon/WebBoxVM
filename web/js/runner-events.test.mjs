...
import { fakeCanvas, fakeStatus } from "./gpu-test-fakes.mjs?v=20260904-virgl-solid-gpu-readback-r1";
import { gpu3dPacket } from "./gpu-test-packets.mjs?v=20260904-virgl-solid-gpu-readback-r1";
