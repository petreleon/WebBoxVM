...
import { GuestDisplay } from "./gpu-display.js?v=20260904-virgl-solid-batch-r1";
import { bindRunnerEvents } from "./runner-events.js?v=20260904-virgl-solid-batch-r1";
import { fakeCanvas, fakeStatus } from "./gpu-test-fakes.mjs?v=20260904-virgl-solid-batch-r1";
import { gpu3dPacket } from "./gpu-test-packets.mjs?v=20260904-virgl-solid-batch-r1";
