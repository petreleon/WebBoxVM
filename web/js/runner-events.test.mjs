...
import { fakeCanvas, fakeStatus } from "./gpu-test-fakes.mjs?v=20260904-virgl-mixed-depth-batch-r1";
import { gpu3dPacket } from "./gpu-test-packets.mjs?v=20260904-virgl-mixed-depth-batch-r1";
