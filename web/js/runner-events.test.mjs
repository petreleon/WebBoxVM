...
import { fakeCanvas, fakeStatus } from "./gpu-test-fakes.mjs?v=20260903-virgl-capset1-r1";
import { gpu3dPacket } from "./gpu-test-packets.mjs?v=20260903-virgl-capset1-r1";
