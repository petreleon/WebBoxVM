...
} from "../../scripts/stamp_web_asset_version.mjs?v=20260904-virgl-material-batch-r1";
import { WEBBOXVM_ASSET_VERSION, versionedUrl } from "./asset-version.js?v=20260904-virgl-material-batch-r1";
