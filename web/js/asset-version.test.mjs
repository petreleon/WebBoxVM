...
} from "../../scripts/stamp_web_asset_version.mjs?v=20260720-firmware-fast-boot-r2";
import { WEBBOXVM_ASSET_VERSION, versionedUrl } from "./asset-version.js?v=20260720-firmware-fast-boot-r2";
