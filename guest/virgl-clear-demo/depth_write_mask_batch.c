...
#define BATCH_WORDS 224u
#define OBJECT_BASE 480u
...
static u32 stream(u32 *words, const struct virgl_resources *resources)
{
    ...
    words[next++] = VIRGL_HEADER(1, 0, 5); words[next++] = OBJECT_BASE + 8u; words[next++] = 17; next += 3;
    words[next++] = VIRGL_HEADER(2, 0, 1); words[next++] = OBJECT_BASE + 8u;
    words[next++] = VIRGL_HEADER(12, 0, 6); words[next++] = 1; words[next++] = 0;
