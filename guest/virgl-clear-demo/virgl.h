...
#define VIRGL_FORMAT_R8G8B8A8_UNORM 67u
...
#define VIRGL_CCMD_RESOURCE_INLINE_WRITE 9u
#define VIRGL_RESOURCE_INLINE_WRITE_WORDS 17u
...
#define VIRGL_TRIANGLE_BYTES 96u
#define VIRGL_INDEX_BUFFER_BYTES 14u
#define VIRGL_TRIANGLE_WORDS 160u
#define VIRGL_TEXTURED_TRIANGLE_BYTES 72u
#define VIRGL_VERTEX_COLOR_TRIANGLE_BYTES 96u
#define VIRGL_TEXTURE_COLOR_TRIANGLE_BYTES 120u
#define VIRGL_TEXTURE_BYTES 16u
#define VIRGL_TEXTURED_TRIANGLE_WORDS 224u
#define VIRGL_TEXTURED_PAIR_WORDS 288u
#define VIRGL_VERTEX_COLOR_WORDS 192u
#define VIRGL_TEXTURE_COLOR_WORDS 256u
...
#define VIRGL_CLAMP_LINEAR_SAMPLER_STATE 0x3292u
#define VIRGL_CLAMP_NEAREST_SAMPLER_STATE 0x1092u
