...
static const u32 texture_vertices[] = {0, 0x3f400000u, 0xbf000000u, 0x3f800000u, 0x3f800000u, 0, 0, 0x3f800000u, 0, 0x3f800000u, 0xbf400000u, 0xbf400000u, 0xbf000000u, 0x3f800000u, 0, 0x3f800000u, 0, 0x3f800000u, 0, 0x3f800000u, 0x3f400000u, 0xbf400000u, 0xbf000000u, 0x3f800000u, 0, 0, 0x3f800000u, 0x3f800000u, 0, 0x3f800000u};
...
static u32 stream(u32 *words, const struct virgl_resources *resources)
{
    ...
    next += shader(words + next, OBJECT_BASE + 8u, 0, 21, texture_vert, sizeof(texture_vert)); next += shader(words + next, OBJECT_BASE + 9u, 1, 30, texture_frag, sizeof(texture_frag));
    ...
    words[next++] = VIRGL_HEADER(1, 5, 13); words[next++] = OBJECT_BASE + 10u; words[next++] = 0; next += 2; words[next++] = VIRGL_FORMAT_R32G32B32A32_FLOAT; words[next++] = 16; next += 2; words[next++] = VIRGL_FORMAT_R32G32B32A32_FLOAT; words[next++] = 32; next += 2; words[next++] = VIRGL_FORMAT_R32G32_FLOAT;
    words[next++] = VIRGL_HEADER(2, 5, 1); words[next++] = OBJECT_BASE + 10u; words[next++] = VIRGL_HEADER(6, 0, 3); words[next++] = 40; words[next++] = 0; words[next++] = resources->textured_resource;
