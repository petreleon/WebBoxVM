...
int virgl_create_textured_resources(long fd, struct virgl_resources *resources)
{
    if (create_texture(fd, &resources->texture_bo, &resources->texture_resource) != 0)
        return -1;
    if (create_texture(fd, &resources->texture_pair_bo, &resources->texture_pair_resource) != 0)
        return -1;
...
static int run_textured_triangle(
    ...
    const u8 expected[4])
{
    if (virgl_upload_textured_vertices(fd, resources->textured_bo, u, 0x3f800000u) != 0)
        return 1;
...
{
    u32 data[] = {
        0, 0x3f400000u, 0, 0x3f800000u, u, v,
        0xbf400000u, 0xbf400000u, 0, 0x3f800000u, u, v,
        0x3f400000u, 0xbf400000u, 0, 0x3f800000u, u, v,
    };
