...
static const u32 vertices[] = {
    ...
    0x3f400000u, 0xbf400000u, 0x3f800000u, 0x3f800000u,
};
...
static int readback(long fd, u32 bo)
{
    ...
    return pixels[offset] == 128 && pixels[offset + 1] == 0 && pixels[offset + 2] == 0 && pixels[offset + 3] == 255 ? 0 : -2;
}
