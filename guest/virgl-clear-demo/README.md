# WebBoxVM standard VirGL uniform, texture, color, depth, and solid-batch probe
...
source-over blend, rasterizer, viewport/scissor, inline-constant and bounded vertex/fragment-uniform triangles, interpolated vertex color, sampled texture, texture-modulated color, canonical depth-less triangles, and an ordered solid-draw batch,
...
`DRAW_VBO`s; the ordered source-over center is `0,128,64,255` in BGRA.
...
`0,128,64,255` center before PASS.
