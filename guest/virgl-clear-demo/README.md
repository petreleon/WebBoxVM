...
source-over blend, rasterizer, viewport/scissor, inline-constant and bounded vertex/fragment-uniform triangles, interpolated vertex color, sampled texture, texture-modulated color, canonical solid/vertex-color/sampled-texture/texture-color depth state, and ordered non-depth plus shared/per-draw-comparison/write-mask depth-tested solid-draw batches,
