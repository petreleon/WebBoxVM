...
- [x] JIT/proof/speed: saved-disk JIT stats/rollback; EL0/sysreg/`SPSR_EL1`/`LDAR`/timer tests; 32-batch pump plus preflight/streaming/page-gen/endpoint validation samples reach ~2.56-2.74B steps in ~150-155s with 0 rejects/skips.
