...
- Measured non-wins not kept: metrics 500ms 500.9s, frame 48ms 497.5s, JIT hot threshold 1 511.4s, VirtIO block scratch buffer 504.1s, step slice 10M 505.9s, JIT block cap 96 518.0s, scalar JIT state sync 505.7s, IRQ preflight shortcut 513.9s, frame batches 256 501.5s.
