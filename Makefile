...
.PHONY: busybox iso-debian-arm64 iso-info terminal-image terminal-debian-arm64 terminal-iso wasm-bindgen-memory64-threads web-pkg web-pkg-serial web-pkg-threaded web web-benchmark web-debian-arm64 graphics-roadmap-test graphics-runner-test graphics-source-role-test graphics-normative-root-test graphics-vulkan-definition-test graphics-source-admission-test graphics-full-suite-root-test graphics-gl-flat-ledger-test graphics-gles-full-closure-ledger-test graphics-gl-gles-ledger-receipt-test graphics-vulkan-ledger-taxonomy-test graphics-vulkan-cache-replay-test graphics-vulkan-full-suite-receipt-test graphics-vulkan-local-shard-receipt-test graphics-role-aware-source-contract-test graphics-profile-source-gate-test graphics-opengl-source-authority-test graphics-gles-source-authority-test graphics-vulkan-registry-inventory-test graphics-f05-source-adapter-test graphics-profile-registration-test test
...
test: graphics-roadmap-test graphics-runner-test graphics-source-role-test graphics-normative-root-test graphics-vulkan-definition-test graphics-source-admission-test graphics-full-suite-root-test graphics-gl-flat-ledger-test graphics-gles-full-closure-ledger-test graphics-gl-gles-ledger-receipt-test graphics-vulkan-ledger-taxonomy-test graphics-vulkan-cache-replay-test graphics-vulkan-full-suite-receipt-test graphics-vulkan-local-shard-receipt-test graphics-role-aware-source-contract-test graphics-profile-source-gate-test graphics-opengl-source-authority-test graphics-gles-source-authority-test graphics-vulkan-registry-inventory-test graphics-f05-source-adapter-test graphics-profile-registration-test
