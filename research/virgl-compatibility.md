...
1. Obtain native end-to-end execution of the newly wired `VGM1` guest phase once shell startup is available, then extend the validated v15/v16/v17 matrix lanes to explicitly checked two-texture or texture-color forms rather than add exact TGSI strings.
